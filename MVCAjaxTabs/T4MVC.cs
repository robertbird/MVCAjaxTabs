...
public static class MVC {
    public static MVCAjaxTabs.Controllers.AccountController Account = new MVCAjaxTabs.Controllers.T4MVC_AccountController();
    public static MVCAjaxTabs.Controllers.HomeController Home = new MVCAjaxTabs.Controllers.T4MVC_HomeController();
...
namespace Links {
    ...
    public static class Scripts {
        ...
        public static readonly string ajaxTabs_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ajaxTabs.min.js") ? Url("ajaxTabs.min.js") : Url("ajaxTabs.js");
